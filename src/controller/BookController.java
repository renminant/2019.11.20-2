...
public class BookController {
    ...
    public ModelAndView selectBookByid(int book_id, Model model) throws SQLException {
        ModelAndView mad = new ModelAndView();
        Book book = bookDao.getBookByid(book_id);
        if (book != null) {
    ...
    public String bookUpdate(Book book, MultipartFile pictureFile) throws IOException {
...
//    public String bill2(@RequestParam(required = false,defaultValue = "1",value = "page")int page, Borrow borrow) throws Exception {
//        PageHelper.startPage(page,5);
//        ModelAndView mad = new ModelAndView();
//        List<Book> bookList = bookDao.getBookList(null);
...
//        bookDao.borrowUpdate(borrow.getBook_id());
