...
<body>
	<div class="main">
		<div class="optitle clearfix">
			...
			<div class="content">
				<table class="box">
					...
					<tr>
						...
						<td>${user.user_id}<input type="hidden" id="userId" value="${user.user_id}"></td>
			...
			<div class="buttons">
		<a href="/ren/selectUserByid.action?user_id=${user.user_id}"><input type="button" id="update" value="修改" class="input-button"></a>
