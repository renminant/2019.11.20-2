...
<input type="hidden" name="userType" value="${userType}">
	<ul class="left-menu">
		<div name="button">
		<li><a href="/ren/billList.action" target="mainFrame">
		...
		<li><a href="/ren/borrowBook.action" target="mainFrame">
			<img src="<%=request.getContextPath()%>/images/btn_jieyue.gif" />
		</a>
		</li>
		<div name="button">
		<li><a href="/ren/userList.action" target="mainFrame">
		...
		<li><a href="/ren/login.action" onClick="logout();">
