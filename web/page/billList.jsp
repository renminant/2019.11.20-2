...
<body>
<form method="post" action="/ren/billList.action">
	<div class="menu">
			...
			<table class="list">
				...
				<c:forEach var="book" items="${pageinfo.list}">
					<tr>
						...
						<td><a href="/ren/selectBillViewByid.action?book_id=${book.book_id}">
		...
		$(function () {
			...
			a.on("click",function () {
				for (var i=0;i<a.length;i++){
					var book_id = $(this)[i].parentNode.parentNode.children[0].innerHTML;
					console.log(book_id);
					location.href = "<%=request.getContextPath()%>/selectBookByid.action?book_id="+book_id;
				}
			})
		})
	</script>
