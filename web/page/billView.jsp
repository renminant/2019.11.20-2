...
<script type="text/javascript" src="<%=request.getContextPath()%>/page/js/jquery-1.8.3.min.js"></script>
</head>
<body>
<div class="main">
	...
	<form method="post" action="/ren/selectBookByid.action">
		<div class="content">
			<table class="box">
			  <tbody>
			  <tr>
					<td class="field">图书编号：</td>
					<td>${book.book_id}<input type="hidden" id="book_id" value="${book.book_id}"></td>
			  </tr>
			   <tr>
		...
		<div class="buttons">
			<a href="${pageContext.servletContext.contextPath}/selectBookByid.action?book_id=${book.book_id}">
				<input type="button" name="update" id="update" value="修改" class="input-button"></a>
			<a href="${pageContext.servletContext.contextPath}/deleteBook.action?book_id=${book.book_id}">
